...
export function ProjectsScreen({ say, onOpen }: ProjectsScreenProps) {
  ...
  const kpis = [
    ...
    { label: "People on payroll", value: portfolio.people, sub: "across all projects" },
  ...
  return (
    <div className="shell">
      <header className="masthead">
        <div>
          ...
          <p className="masthead__lede">
            Everything — people, contracts, leaves and payroll — lives inside a project. Pick one to
            continue, or open a new one.
          </p>
        </div>
      ...
      <div className="columns">
        <div>
          {/* Pending leave and monthly payroll, the mockup's other two, need
              the leave and payroll slices. */}
